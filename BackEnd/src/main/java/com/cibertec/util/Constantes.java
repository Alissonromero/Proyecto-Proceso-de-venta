...
public class Constantes {
  ...
  public static final String MENSAJE_CON_NO_EXISTE = "No existe datos para la consulta";
	public static final String MENSAJE_CON_ERROR = "Error en la consulta";

		public static final String MENSAJE_DNI_YA_EXISTE = "Ya existe dicho el DNI : ";
  public static final String MENSAJE_CORREO_YA_EXISTE = "Ya existe dicho el Correo: ";
